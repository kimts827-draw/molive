...
export const INDUSTRY_PROFILES: Record<IndustryId, IndustryProfile> = {
  fashion: {
    ...
    headerPool: ["centered-brand", "overlay-minimal", "split-utility"],
  ...
  beauty: {
    ...
    headerPool: ["centered-brand", "overlay-minimal"],
  ...
  food: {
    ...
    headerPool: ["centered-brand", "split-utility", "overlay-minimal"],
  ...
  health: {
    ...
    headerPool: ["split-utility", "centered-brand"],
  ...
  auto: {
    ...
    positionShift: { specs: -0.06, featuredProducts: -0.1, categoryGrid: -0.02 },
    heroPool: ["cinematic-still", "product-forward", "banner-stack"],
    headerPool: ["split-utility", "overlay-minimal"],
  ...
  interior: {
    ...
    headerPool: ["centered-brand", "split-utility"],
  ...
  pet: {
    ...
    positionShift: { featuredProducts: -0.12, socialGallery: -0.02 },
    heroPool: ["product-forward", "full-bleed", "banner-stack"],
    headerPool: ["split-utility", "centered-brand"],
    presentationPool: ["compact-five", "grid-four", "featured-grid"],
    footerPool: ["warm-tinted", "paper-light"],
    typeScalePool: ["rounded-warm", "sans-modern"],
    imageTreatmentPool: ["vivid-clean", "warm-film"],
    densityPool: ["dense", "regular"],
    bodyCount: [5, 7],
  },
  kids: {
    ...
    positionShift: { featuredProducts: -0.06, materials: -0.04 },
  ...
  digital: {
    ...
    positionShift: { specs: -0.08, featuredProducts: -0.04 },
  ...
  general: {
    ...
    headerPool: ["split-utility", "centered-brand", "overlay-minimal"],
    presentationPool: ["grid-four", "large-grid", "editorial-two", "featured-grid", "compact-five"],
    footerPool: ["paper-light", "ink-dark", "warm-tinted"],
    typeScalePool: ["sans-modern", "serif-display", "rounded-warm"],
    imageTreatmentPool: ["vivid-clean", "desaturated-editorial", "warm-film", "dark-cinematic"],
