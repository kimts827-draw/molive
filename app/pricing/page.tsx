...
export default async function PricingPage() {
  ...
  return <main className="pricing-page">
    ...
    <section className="pricing-content"><OrderPanel signedIn={Boolean(user)} bank={bankTransferConfig()} tossTestClientKey={process.env.NEXT_PUBLIC_TOSS_TEST_CLIENT_KEY?.trim() ?? ""} />
