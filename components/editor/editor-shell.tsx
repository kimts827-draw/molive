  ...
  return (
    <main className="editor-app">
      <header className="editor-topbar">
        ...
        <div className="viewport-switcher" aria-label="미리보기 기기"><button className={viewport === "desktop" ? "active" : ""} onClick={() => setViewport("desktop")}><Monitor size={15} /></button><button className={viewport === "tablet" ? "active" : ""} onClick={() => setViewport("tablet")}><Tablet size={15} /></button><button className={viewport === "mobile" ? "active" : ""} onClick={() => setViewport("mobile")}><Smartphone size={15} /></button></div>
      ...
      <div className="editor-workspace">
        ...
        <section className="editor-stage"><div className="stage-toolbar"><span>{viewport === "desktop" ? "1440 px" : viewport === "tablet" ? "1024 px" : "390 px"}</span><b>HTML/CSS 직접 렌더링</b></div><div className={`canvas-viewport viewport-${viewport}`}><EditorCanvas source={source} selection={selection} viewport={viewport} onSelect={(next) => { setSelection(next); setRightOpen(true); }} /></div></section>
